...
<form method="POST" action="{{ route('login') }}" class="space-y-6">
    ...
    <div>
        <button type="submit" class="w-full bg-red-600 hover:bg-black text-white font-bold py-4 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all active:scale-95 text-lg uppercase tracking-widest">
            LOG IN TO BPRO
        </button>
    </div>
    ...
    <a href="{{ route('register') }}" class="block w-full text-center border-2 border-gray-900 text-gray-900 hover:bg-gray-900 hover:text-white font-bold py-3 rounded-xl transition-all uppercase tracking-widest text-sm">
